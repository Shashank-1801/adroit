...
def analyse(lines):
    ...
    if play_symbol == "X":
        ...
        opponent = "X"
    rem_time = float(str(lines[3]).strip("\n"))
    print("rem_time of search is ", rem_time)
...
def start_processing():
    ...
    depth = calculate_depth(rem_time)
    print()
    if mode == "MINIMAX":
